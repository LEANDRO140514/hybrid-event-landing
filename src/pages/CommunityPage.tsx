...
const features = [
  {
    ...
    title: 'FEED DE ATLETAS',
    desc: 'Comparte tus entrenamientos y sigue a otros competidores.',
    status: 'PRÓXIMAMENTE',
  },
  {
    icon: <EmojiEventsIcon sx={{ fontSize: 24 }} />,
    title: 'LEADERBOARDS',
    desc: 'Rankings por categoría y actividad semanal.',
    status: 'PRÓXIMAMENTE',
  },
  {
    icon: <WhatshotIcon sx={{ fontSize: 24 }} />,
    title: '¿QUIÉN COMPITE?',
    desc: 'Conoce a los atletas inscritos en tu categoría.',
    status: 'PRÓXIMAMENTE',
  },
]
          ...
          <Card key={f.title} sx={{ bgcolor: '#111111', border: '1px solid rgba(230,242,177,0.15)', borderRadius: 0 }}>
            <CardContent sx={{ p: 2.5, '&:last-child': { pb: 2.5 } }}>
              <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
                <Box sx={{ color: '#E9C7DF', width: 40, display: 'grid', placeItems: 'center' }}>
                  {f.icon}
                </Box>
                <Box sx={{ flex: 1 }}>
