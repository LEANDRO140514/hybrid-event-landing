...
export const CATALOGO: Producto[] = [
  ...
  { code: 'IND-M', nombre: 'Individual Mujer (Open)', bloque: 'COMPITE', tipo: 'Individual', integrantes: 1, dia: 'Domingo', sesion: 'AM', precio: 1400, precioUnidad: 'por persona', incluyeChip: true },
  { code: 'IND-PRO-H', nombre: 'Individual Pro Hombre', bloque: 'COMPITE', tipo: 'Individual', integrantes: 1, dia: 'Domingo', sesion: 'AM', precio: 1400, precioUnidad: 'por persona', incluyeChip: true },
  { code: 'IND-PRO-M', nombre: 'Individual Pro Mujer', bloque: 'COMPITE', tipo: 'Individual', integrantes: 1, dia: 'Domingo', sesion: 'AM', precio: 1400, precioUnidad: 'por persona', incluyeChip: true },

  // ── EXPERIENCE — ½ Hybrid — Sábado 10 · AM ──
  { code: 'HALF-IND-M', nombre: '½ Hybrid Individual Mujer', bloque: 'EXPERIENCE', tipo: '½ Hybrid Individual', integrantes: 1, dia: 'Sábado', sesion: 'AM', precio: 800, precioUnidad: 'por persona', incluyeChip: true },
  { code: 'HALF-IND-H', nombre: '½ Hybrid Individual Hombre', bloque: 'EXPERIENCE', tipo: '½ Hybrid Individual', integrantes: 1, dia: 'Sábado', sesion: 'AM', precio: 800, precioUnidad: 'por persona', incluyeChip: true },
  { code: 'HALF-DOB-MM', nombre: '½ Hybrid Dobles Mujeres', bloque: 'EXPERIENCE', tipo: '½ Hybrid Dobles', integrantes: 2, dia: 'Sábado', sesion: 'AM', precio: 1600, precioUnidad: 'por pareja ($800 c/u)', incluyeChip: true },
  { code: 'HALF-DOB-HH', nombre: '½ Hybrid Dobles Hombres', bloque: 'EXPERIENCE', tipo: '½ Hybrid Dobles', integrantes: 2, dia: 'Sábado', sesion: 'AM', precio: 1600, precioUnidad: 'por pareja ($800 c/u)', incluyeChip: true },
  { code: 'HALF-DOB-MH', nombre: '½ Hybrid Dobles Mixto', bloque: 'EXPERIENCE', tipo: '½ Hybrid Dobles', integrantes: 2, dia: 'Sábado', sesion: 'AM', precio: 1600, precioUnidad: 'por pareja ($800 c/u)', incluyeChip: true },

  // ── EXPERIENCE — Workout Experience — Sábado 10 · AM · $300 ──
  { code: 'WOD-M', nombre: 'Workout Experience Mujer', bloque: 'EXPERIENCE', tipo: 'Workout Experience', integrantes: 1, dia: 'Sábado', sesion: 'AM', precio: 300, precioUnidad: 'por persona', incluyeChip: false },
  { code: 'WOD-H', nombre: 'Workout Experience Hombre', bloque: 'EXPERIENCE', tipo: 'Workout Experience', integrantes: 1, dia: 'Sábado', sesion: 'AM', precio: 300, precioUnidad: 'por persona', incluyeChip: false },
